...
public partial class Form1 {
    ...
    {
        var flow = Vertical(); flow.Padding=new Padding(12);flow.Margin=new Padding(0); flow.Controls.Add(Label("Çalışma alanı", 14, true));
        ...
        var tabs=new TabControl{Dock=DockStyle.Fill,Padding=new Point(14,7),Font=BarcodePrinter.Themes.AppTypography.Body(),ItemSize=new Size(150,30),SizeMode=TabSizeMode.Fixed};
        ...
        var local=new TabPage("Genel ayarlar"){AutoScroll=true,Padding=new Padding(10)};
        ...
        content.Controls.Remove(flow);var localSection=new AppSection("Yerel veri ve yazıcı");localSection.Body.Controls.Add(flow);local.Controls.Add(localSection);
