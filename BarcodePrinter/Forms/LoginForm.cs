...
public sealed class LoginForm : AppWindow
{
    ...
    public LoginForm(CompanyProfile? company=null)
    {
        ...
        bottom.Controls.Add(login);bottom.Controls.Add(error);layout.Controls.Add(brand,0,0);layout.Controls.Add(title,0,1);layout.Controls.Add(new Label{Text="Kullanıcı kodu",Dock=DockStyle.Fill,TextAlign=ContentAlignment.BottomLeft},0,2);layout.Controls.Add(user,0,3);layout.Controls.Add(new Label{Text="Şifre",Dock=DockStyle.Fill,TextAlign=ContentAlignment.BottomLeft},0,4);layout.Controls.Add(password,0,5);layout.Controls.Add(bottom,0,6);Controls.Add(layout);
