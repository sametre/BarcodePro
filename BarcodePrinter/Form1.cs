...
public partial class Form1 : AppWindow
{
    ...
    public Form1(string? inventoryPath = null,RemoteInventoryClient? remote = null)
    {
        ...
        Text=clientMode?"Barcode Pro • Client | Stok ve Etiket Yönetimi":"Barcode Pro • Server Yönetimi | Stok ve Etiket Yönetimi";Size=new Size(1200,750);MinimumSize=new Size(1024,768);StartPosition=FormStartPosition.CenterScreen;Font=AppTypography.Body();
