...
public partial class Form1 : AppWindow
{
    ...
    private void UpdateConnection(){var printer=new PrinterSettingsService().Profiles().FirstOrDefault()?.PrinterName??"Seçilmedi";connection.Text=$"Barcode Pro 2.1 Beta 7 · Yönetici     •     Yazıcı: {printer}     •     Veri: {(clientMode?"Barcode Pro Server":"Yerel JSON / Bağlı")}";}
