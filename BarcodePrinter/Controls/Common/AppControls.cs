...
public class AppButton : Button
{
    ...
    public AppButton() { FlatStyle=FlatStyle.Flat;FlatAppearance.BorderSize=0;Cursor=Cursors.Hand;AutoSize=true;Height=28;MinimumSize=new Size(0,28);Padding=new Padding(7,3,7,3);Margin=new Padding(0,0,6,0);Font=new Font("Segoe UI",9);ImageAlign=ContentAlignment.MiddleLeft;TextImageRelation=TextImageRelation.ImageBeforeText;TextAlign=ContentAlignment.MiddleCenter; }
    public override Size GetPreferredSize(Size proposedSize){var size=base.GetPreferredSize(proposedSize);return new Size(size.Width,Math.Max(28,(int)(28*DeviceDpi/96f)));}
...
public class AppPanel : Panel { public AppPanel() { DoubleBuffered = true; Padding = new Padding(16); } }
...
public class AppDataGrid : DataGridView
{
    public AppDataGrid()
    {
        DoubleBuffered = true; Dock = DockStyle.Fill; BorderStyle = BorderStyle.None; AllowUserToAddRows = false; AllowUserToDeleteRows = false; ReadOnly = true; MultiSelect = true; SelectionMode = DataGridViewSelectionMode.FullRowSelect; AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.Fill; RowHeadersVisible = false; EnableHeadersVisualStyles = false; ColumnHeadersBorderStyle=DataGridViewHeaderBorderStyle.Single; CellBorderStyle = DataGridViewCellBorderStyle.SingleHorizontal; RowTemplate.Height = 36; ColumnHeadersHeight = 34; AllowUserToOrderColumns = true;
        ...
        DefaultCellStyle.Font = AppTypography.Body(); ColumnHeadersDefaultCellStyle.Font = new Font("Segoe UI",9,FontStyle.Bold); DefaultCellStyle.Padding = new Padding(6); ThemeManager.Apply(this);
    }
}
...
public class AppToolbar : FlowLayoutPanel
{
    ...
    public AppToolbar(){Dock=DockStyle.Top;AutoSize=true;MinimumSize=new Size(0,42);Padding=new Padding(12,6,12,6);WrapContents=true;}
